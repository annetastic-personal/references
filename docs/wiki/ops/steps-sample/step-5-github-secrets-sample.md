...
| `SERVER_PATH` | `/home/annetastic/portfolio` | Server path containing `releases/` and `current` symlink |

> **Multi-repo note:**
> For multiple repositories, use a unique subfolder for each repo, e.g., `/home/annetastic/<repo-name>`. This keeps deployments isolated and organized per project.

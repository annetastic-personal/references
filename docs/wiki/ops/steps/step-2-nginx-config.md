...
Worked example: [Step 2 Sample](https://github.com/<old-org>/references/wiki/step-2-nginx-config-sample)
...
[← Step 1](https://github.com/<old-org>/references/wiki/step-1-server-layout) | [← Back to Index](../cicd-index.md) | [Next: Step 3 →](https://github.com/<old-org>/references/wiki/step-3-deploy-key)

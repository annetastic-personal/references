...
Worked example: [Step 6 Sample](https://github.com/<old-org>/references/wiki/step-6-runner-setup-sample)
...
[← Step 5](https://github.com/<old-org>/references/wiki/step-5-github-secrets) | [← Back to Index](../cicd-index.md) | [Next: Step 7 →](https://github.com/<old-org>/references/wiki/step-7-workflow)

...
1. Add a `package.json` that declares the runtime, dependencies, and publish script.
2. Install the dependencies needed by the scaffold script.
3. Validate the script against the selected Node runtime.
